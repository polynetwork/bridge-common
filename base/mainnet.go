...
var CHAINS = []uint64{
	...
	CELO, CLOVER, CONFLUX, ASTAR, APTOS, BRISE, RIPPLE,
}

var ETH_CHAINS = []uint64{
	ZION, ZIONCHAIN, ETH, GOERLI, BSC, HECO, OK, MATIC, O3, PLT, ARBITRUM, XDAI, OPTIMISM, FANTOM, AVA, METIS, BOBA, PIXIE, OASIS, HSC, HARMONY,
