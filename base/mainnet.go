...
var CHAINS = []uint64{
	...
	ZKSYNC, CELO, CLOVER, CONFLUX, ASTAR, BRISE, APTOS, APTOS2, DEXIT, CLOUDTX, POLYGONZK, NAUTILUS, XINFIN,
}

var ETH_CHAINS = []uint64{
	ETH, BSC, HECO, OK, MATIC, O3, PLT, ARBITRUM, XDAI, OPTIMISM, FANTOM, AVA, METIS, BOBA, PIXIE, OASIS, HSC, HARMONY,
	BYTOM, BCSPALETTE, KCC, ONTEVM, MILKO, CUBE, KAVA, ZKSYNC, CELO, CLOVER, CONFLUX, ASTAR, BRISE, DEXIT, CLOUDTX,
